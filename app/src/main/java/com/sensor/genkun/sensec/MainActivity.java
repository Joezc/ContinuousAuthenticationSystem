...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutIdentification = (LinearLayout) findViewById(R.id.layoutIdentification);
        layoutBuildModels = (LinearLayout) findViewById(R.id.layoutBuildModels);
        layoutTestModels = (LinearLayout) findViewById(R.id.layoutTestModels);
        layoutAuthentication = (LinearLayout) findViewById(R.id.layoutAuthentication);
        editBuildTotalTime = (EditText) findViewById(R.id.editBuildTotalTime);
        editBuildWindowTime = (EditText) findViewById(R.id.editBuildWindowTime);
        editBuildCentroids = (EditText) findViewById(R.id.editBuildCentroids);
        buttonStart = (Button) findViewById(R.id.buttonStart);
        buttonClaTestStart = (Button) findViewById(R.id.buttonClaTestStart);
        buttonAuthStart = (Button) findViewById(R.id.buttonAuthStart);
        buttonAuthStop = (Button) findViewById(R.id.buttonAuthStop);
        imageViewExperiment = (ImageView) findViewById(R.id.imageViewExperiment);
        imageBuild = (ImageView) findViewById(R.id.imageBuild);
        imageAuthTraining = (ImageView) findViewById(R.id.imageAuthTest);
        switchExperiment = (Switch) findViewById(R.id.switchExperiment);
        switchBuild = (Switch) findViewById(R.id.switchBuild);
        switchAuthTest = (Switch) findViewById(R.id.switchAuthTest);
        spinnerBuildGroup = (Spinner) findViewById(R.id.spinnerBuildGroup);
        checkBuildNewData = (CheckBox) findViewById(R.id.checkBuildNewData);
        checkTestNewData = (CheckBox) findViewById(R.id.checkTestNewData);
    ...
    public void onButtonStartClick(View view){
        ...
        if (checkBuildNewData.isChecked()) {
            ...
            intent.setClass(MainActivity.this, DataService.class);
    ...
    public void onButtonAuthStopClick(View view) {
        ...
        Intent intent = new Intent();
        intent.setClass(MainActivity.this, TempService.class);
        startService(intent);
    }
