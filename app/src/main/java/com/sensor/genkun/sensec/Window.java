...
import com.sensor.genkun.Jama.Complex;
import com.sensor.genkun.Jama.FFT;
...
public class Window {
    ...
    public Window(double[][] acc, double[][] ori, double[][] mag, double[][] gyr) {
        //accelerometer = acc;
        //orientation = ori;
        //magnetic = mag;
        //gyroscope = gyr;
    ...
    private double median(double[] vector) {
        ...
        DataProcessing.quickSort(tmp, 0, tmp.length - 1);
