...
public class DataService extends IntentService implements SensorEventListener{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!isAuth) {
            if (isNewData) {
                rootPath = MainActivity.rootPath + groupName + "/";
            } else {
                rootPath = MainActivity.rootPath;
            }
            TextFile.makeRootDirectory(MainActivity.rootPath);
            ...
            TextFile.makeRootDirectory(MainActivity.rootPath + "Models/");
            ...
            fileNameModels = MainActivity.rootPath + "/Models/" + groupName + ".txt";
            ...
            rootPath = MainActivity.rootPath + "Authentication/";
            TextFile.makeRootDirectory(MainActivity.rootPath);
            TextFile.makeRootDirectory(rootPath);
            TextFile.makeRootDirectory(rootPath + "Accelerometer/");
            TextFile.makeRootDirectory(rootPath + "Orientation/");
